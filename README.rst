...
This module is written to be compatible with the [scikit-learn algorithms](http://scikit-learn.org/stable/supervised_learning.html) and the other scikit-learn-compatible algorithms.
